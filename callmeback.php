...
<head>
	...
	<style>
		...
		#contact h1 {
			background: rgba(13, 173, 147, 0.61);
		...
		.contactbutton {
			background: rgba(230, 0, 42, 0.534);
...
<body>
	<section id="contact">
		<div class="sectionheader">
			<h1>Hemen Iletişime geç!</h1>
		</div>
		<article>
			<p>Tüm isteklerinizi dilerseniz buradan Konu Başlığı'na isteklerinizi yazarak iletişime geçin veya Detaylı
				anlatmak istiyorsanız, formu doldurun anında iletişime geçelim. </p>
			...
			<form action="" method="post" class="contactform">
				<p class="input_wrapper"><input type="text" name="contact_nom" value="" id="contact_nom"><label
						for="contact_nom">ADINIZ</label></p>
				<p class="input_wrapper"><input type="text" name="contact_email" value="" id="contact_email"  required><label
						for="contact_email">EMAIL</label></p>
				<p class="input_wrapper"><input type="text" name="contact_sujet" value="" id="contact_sujet"><label
						for="contact_sujet">KONU</label></p>
				<p class="textarea_wrapper"><textarea name="contact_message" id="contact_message" maxlength="6000" required ></textarea></p>
				<p class="submit_wrapper"><input type="submit" value="GONDER"></p>
			</form>
		</article>
	</section>
</body>
